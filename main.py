...
def attack(char_name: str, char_class: str) -> str:
    """Функция вичисления атаки."""
    if char_class == 'warrior':
        return (f'{char_name} нанёс урон равный '
                f'{5 + randint(3, 5)}')
    if char_class == 'mage':
        return (f'{char_name} нанёс урон равный '
                f'{5 + randint(5, 10)}')
...
def special(char_name: str, char_class: str) -> str:
    """Функция вычисления специального умения."""
    if char_class == 'warrior':
